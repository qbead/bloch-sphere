...
Defined in: [src/components/component.ts:2](https://github.com/qbead/bloch-sphere/blob/3766f2f3df1d632e3531ec172a87f2dd1e6d0061/src/components/component.ts#L2)
...
> **new BaseComponent**(`name`?): [`BaseComponent`](BaseComponent.md)

Defined in: [src/components/component.ts:5](https://github.com/qbead/bloch-sphere/blob/3766f2f3df1d632e3531ec172a87f2dd1e6d0061/src/components/component.ts#L5)
...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="_color"></a> `_color` | `protected` | `Color` | `undefined` | - | - | [src/components/component.ts:3](https://github.com/qbead/bloch-sphere/blob/3766f2f3df1d632e3531ec172a87f2dd1e6d0061/src/components/component.ts#L3) |
...
| <a id="name-1"></a> `name` | `public` | `string` | `""` | Optional name of the object **Remarks** _(doesn't need to be unique)_. | `THREE.Object3D.name` | node\_modules/@types/three/src/core/Object3D.d.ts:122 |
...
| <a id="up"></a> `up` | `public` | `Vector3` | Object3D.DEFAULT_UP - that is `(0, 1, 0)`. | This is used by the [lookAt](BaseComponent.md#lookat) method, for example, to determine the orientation of the result. | `THREE.Object3D.up` | node\_modules/@types/three/src/core/Object3D.d.ts:151 |
...
#### See
 ...
 - [attach](BaseComponent.md#attach)
...
| `listener` | `EventListener`\<`Object3DEventMap`\[`T`\], `T`, [`BaseComponent`](BaseComponent.md)\> | The function that gets called when the event is fired. |
...
| `listener` | `EventListener`\<`Object3DEventMap`\[`T`\], `T`, [`BaseComponent`](BaseComponent.md)\> | The listener function that gets removed. |
