...
Defined in: [src/components/operator-display.ts:20](https://github.com/qbead/bloch-sphere/blob/41247d60e67bd802cc21854379a06362e5d0957c/src/components/operator-display.ts#L20)
...
> **new OperatorDisplay**(`op`?): `OperatorDisplay`

Defined in: [src/components/operator-display.ts:26](https://github.com/qbead/bloch-sphere/blob/41247d60e67bd802cc21854379a06362e5d0957c/src/components/operator-display.ts#L26)
...
| <a id="innergroup"></a> `innerGroup` | `public` | `Group` | `undefined` | - | - | [src/components/operator-display.ts:22](https://github.com/qbead/bloch-sphere/blob/41247d60e67bd802cc21854379a06362e5d0957c/src/components/operator-display.ts#L22) |
...
| <a id="label"></a> `label` | `public` | [`Label`](Label.md) | `undefined` | - | - | [src/components/operator-display.ts:23](https://github.com/qbead/bloch-sphere/blob/41247d60e67bd802cc21854379a06362e5d0957c/src/components/operator-display.ts#L23) |
...
| <a id="operator"></a> `operator` | `public` | [`Operator`](Operator.md) | `undefined` | - | - | [src/components/operator-display.ts:21](https://github.com/qbead/bloch-sphere/blob/41247d60e67bd802cc21854379a06362e5d0957c/src/components/operator-display.ts#L21) |
...
| `listener` | `EventListener`\<`Object3DEventMap`\[`T`\], `T`, `OperatorDisplay`\> | The function that gets called when the event is fired. |
...
Defined in: [src/components/operator-display.ts:137](https://github.com/qbead/bloch-sphere/blob/41247d60e67bd802cc21854379a06362e5d0957c/src/components/operator-display.ts#L137)
...
| `listener` | `EventListener`\<`Object3DEventMap`\[`T`\], `T`, `OperatorDisplay`\> | The listener function that gets removed. |
...
Defined in: [src/components/operator-display.ts:122](https://github.com/qbead/bloch-sphere/blob/41247d60e67bd802cc21854379a06362e5d0957c/src/components/operator-display.ts#L122)
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `op` | [`Operator`](Operator.md) | The operator to display |
