...
[@qbead/bloch-sphere](../index.md) / PathDisplay

# Class: PathDisplay

Defined in: [src/components/path-display.ts:67](https://github.com/qbead/bloch-sphere/blob/3766f2f3df1d632e3531ec172a87f2dd1e6d0061/src/components/path-display.ts#L67)
...
> **new PathDisplay**(`path`?): [`PathDisplay`](PathDisplay.md)

Defined in: [src/components/path-display.ts:68](https://github.com/qbead/bloch-sphere/blob/3766f2f3df1d632e3531ec172a87f2dd1e6d0061/src/components/path-display.ts#L68)

#### Parameters

| Parameter | Type |
| ------ | ------ |
| `path`? | [`BlochVector`](BlochVector.md)[] |
...
| <a id="up"></a> `up` | `public` | `Vector3` | Object3D.DEFAULT_UP - that is `(0, 1, 0)`. | This is used by the [lookAt](PathDisplay.md#lookat) method, for example, to determine the orientation of the result. | [`BaseComponent`](BaseComponent.md).[`up`](BaseComponent.md#up) | node\_modules/@types/three/src/core/Object3D.d.ts:151 |
...
| `listener` | `EventListener`\<`Object3DEventMap`\[`T`\], `T`, [`PathDisplay`](PathDisplay.md)\> | The function that gets called when the event is fired. |
...
| `listener` | `EventListener`\<`Object3DEventMap`\[`T`\], `T`, [`PathDisplay`](PathDisplay.md)\> | The listener function that gets removed. |
...
Defined in: [src/components/path-display.ts:76](https://github.com/qbead/bloch-sphere/blob/3766f2f3df1d632e3531ec172a87f2dd1e6d0061/src/components/path-display.ts#L76)

#### Parameters

| Parameter | Type |
| ------ | ------ |
| `vertices` | [`BlochVector`](BlochVector.md)[] |
