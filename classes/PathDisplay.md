...
Defined in: [src/components/path-display.ts:84](https://github.com/qbead/bloch-sphere/blob/41247d60e67bd802cc21854379a06362e5d0957c/src/components/path-display.ts#L84)
...
> **new PathDisplay**(`path`?): `PathDisplay`

Defined in: [src/components/path-display.ts:85](https://github.com/qbead/bloch-sphere/blob/41247d60e67bd802cc21854379a06362e5d0957c/src/components/path-display.ts#L85)
...
| `listener` | `EventListener`\<`Object3DEventMap`\[`T`\], `T`, `PathDisplay`\> | The function that gets called when the event is fired. |
...
| `listener` | `EventListener`\<`Object3DEventMap`\[`T`\], `T`, `PathDisplay`\> | The listener function that gets removed. |
...
Defined in: [src/components/path-display.ts:94](https://github.com/qbead/bloch-sphere/blob/41247d60e67bd802cc21854379a06362e5d0957c/src/components/path-display.ts#L94)
