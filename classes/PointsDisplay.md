...
Defined in: [src/components/points-display.ts:5](https://github.com/qbead/bloch-sphere/blob/3766f2f3df1d632e3531ec172a87f2dd1e6d0061/src/components/points-display.ts#L5)
...
> **new PointsDisplay**(`points`?): [`PointsDisplay`](PointsDisplay.md)

Defined in: [src/components/points-display.ts:8](https://github.com/qbead/bloch-sphere/blob/3766f2f3df1d632e3531ec172a87f2dd1e6d0061/src/components/points-display.ts#L8)
...
| <a id="up"></a> `up` | `public` | `Vector3` | Object3D.DEFAULT_UP - that is `(0, 1, 0)`. | This is used by the [lookAt](PointsDisplay.md#lookat) method, for example, to determine the orientation of the result. | [`BaseComponent`](BaseComponent.md).[`up`](BaseComponent.md#up) | node\_modules/@types/three/src/core/Object3D.d.ts:151 |
...
Defined in: [src/components/points-display.ts:48](https://github.com/qbead/bloch-sphere/blob/3766f2f3df1d632e3531ec172a87f2dd1e6d0061/src/components/points-display.ts#L48)
...
Defined in: [src/components/points-display.ts:40](https://github.com/qbead/bloch-sphere/blob/3766f2f3df1d632e3531ec172a87f2dd1e6d0061/src/components/points-display.ts#L40)
...
Defined in: [src/components/points-display.ts:44](https://github.com/qbead/bloch-sphere/blob/3766f2f3df1d632e3531ec172a87f2dd1e6d0061/src/components/points-display.ts#L44)
...
#### See
 ...
 - [attach](PointsDisplay.md#attach)
...
| `listener` | `EventListener`\<`Object3DEventMap`\[`T`\], `T`, [`PointsDisplay`](PointsDisplay.md)\> | The function that gets called when the event is fired. |
...
| `listener` | `EventListener`\<`Object3DEventMap`\[`T`\], `T`, [`PointsDisplay`](PointsDisplay.md)\> | The listener function that gets removed. |
...
Defined in: [src/components/points-display.ts:53](https://github.com/qbead/bloch-sphere/blob/3766f2f3df1d632e3531ec172a87f2dd1e6d0061/src/components/points-display.ts#L53)
