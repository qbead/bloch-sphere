...
[@qbead/bloch-sphere](../index.md) / QubitArrow

# Class: QubitArrow

Defined in: [src/components/qubit-arrow.ts:7](https://github.com/qbead/bloch-sphere/blob/3766f2f3df1d632e3531ec172a87f2dd1e6d0061/src/components/qubit-arrow.ts#L7)
...
> **new QubitArrow**(): [`QubitArrow`](QubitArrow.md)

Defined in: [src/components/qubit-arrow.ts:11](https://github.com/qbead/bloch-sphere/blob/3766f2f3df1d632e3531ec172a87f2dd1e6d0061/src/components/qubit-arrow.ts#L11)
...
| <a id="label"></a> `label` | `public` | [`Label`](Label.md) | `undefined` | - | - | [src/components/qubit-arrow.ts:9](https://github.com/qbead/bloch-sphere/blob/3766f2f3df1d632e3531ec172a87f2dd1e6d0061/src/components/qubit-arrow.ts#L9) |
...
| <a id="up"></a> `up` | `public` | `Vector3` | Object3D.DEFAULT_UP - that is `(0, 1, 0)`. | This is used by the [lookAt](QubitArrow.md#lookat) method, for example, to determine the orientation of the result. | [`BaseComponent`](BaseComponent.md).[`up`](BaseComponent.md#up) | node\_modules/@types/three/src/core/Object3D.d.ts:151 |
...
Defined in: [src/components/qubit-arrow.ts:32](https://github.com/qbead/bloch-sphere/blob/3766f2f3df1d632e3531ec172a87f2dd1e6d0061/src/components/qubit-arrow.ts#L32)
...
| `listener` | `EventListener`\<`Object3DEventMap`\[`T`\], `T`, [`QubitArrow`](QubitArrow.md)\> | The function that gets called when the event is fired. |
...
Defined in: [src/components/qubit-arrow.ts:37](https://github.com/qbead/bloch-sphere/blob/3766f2f3df1d632e3531ec172a87f2dd1e6d0061/src/components/qubit-arrow.ts#L37)
...
| `listener` | `EventListener`\<`Object3DEventMap`\[`T`\], `T`, [`QubitArrow`](QubitArrow.md)\> | The listener function that gets removed. |
