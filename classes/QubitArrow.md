...
Defined in: [src/components/qubit-arrow.ts:21](https://github.com/qbead/bloch-sphere/blob/9ff2dae0481f00679728b83f1e83d06a69a548d1/src/components/qubit-arrow.ts#L21)

A display for just a qubit arrow

## See

[QubitDisplay](QubitDisplay.md) for a full qubit display
...
Defined in: [src/components/qubit-arrow.ts:25](https://github.com/qbead/bloch-sphere/blob/9ff2dae0481f00679728b83f1e83d06a69a548d1/src/components/qubit-arrow.ts#L25)
...
| <a id="label"></a> `label` | `public` | [`Label`](Label.md) | `undefined` | - | - | [src/components/qubit-arrow.ts:23](https://github.com/qbead/bloch-sphere/blob/9ff2dae0481f00679728b83f1e83d06a69a548d1/src/components/qubit-arrow.ts#L23) |
...
Defined in: [src/components/qubit-arrow.ts:46](https://github.com/qbead/bloch-sphere/blob/9ff2dae0481f00679728b83f1e83d06a69a548d1/src/components/qubit-arrow.ts#L46)
...
| `listener` | `EventListener`\<`Object3DEventMap`\[`T`\], `T`, `QubitArrow`\> | The function that gets called when the event is fired. |
...
Defined in: [src/components/qubit-arrow.ts:51](https://github.com/qbead/bloch-sphere/blob/9ff2dae0481f00679728b83f1e83d06a69a548d1/src/components/qubit-arrow.ts#L51)
...
| `listener` | `EventListener`\<`Object3DEventMap`\[`T`\], `T`, `QubitArrow`\> | The listener function that gets removed. |
