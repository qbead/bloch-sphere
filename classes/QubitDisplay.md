...
Defined in: [src/components/qubit-display.ts:10](https://github.com/qbead/bloch-sphere/blob/3766f2f3df1d632e3531ec172a87f2dd1e6d0061/src/components/qubit-display.ts#L10)
...
> **new QubitDisplay**(`q`?): [`QubitDisplay`](QubitDisplay.md)

Defined in: [src/components/qubit-display.ts:16](https://github.com/qbead/bloch-sphere/blob/3766f2f3df1d632e3531ec172a87f2dd1e6d0061/src/components/qubit-display.ts#L16)
...
| <a id="angleindicators"></a> `angleIndicators` | `public` | [`AngleIndicators`](AngleIndicators.md) | `undefined` | - | - | [src/components/qubit-display.ts:13](https://github.com/qbead/bloch-sphere/blob/3766f2f3df1d632e3531ec172a87f2dd1e6d0061/src/components/qubit-display.ts#L13) |
...
| <a id="arrow"></a> `arrow` | `public` | [`QubitArrow`](QubitArrow.md) | `undefined` | - | - | [src/components/qubit-display.ts:11](https://github.com/qbead/bloch-sphere/blob/3766f2f3df1d632e3531ec172a87f2dd1e6d0061/src/components/qubit-display.ts#L11) |
...
| <a id="state"></a> `state` | `public` | [`BlochVector`](BlochVector.md) | `undefined` | - | - | [src/components/qubit-display.ts:14](https://github.com/qbead/bloch-sphere/blob/3766f2f3df1d632e3531ec172a87f2dd1e6d0061/src/components/qubit-display.ts#L14) |
...
| <a id="up"></a> `up` | `public` | `Vector3` | Object3D.DEFAULT_UP - that is `(0, 1, 0)`. | This is used by the [lookAt](QubitDisplay.md#lookat) method, for example, to determine the orientation of the result. | [`BaseComponent`](BaseComponent.md).[`up`](BaseComponent.md#up) | node\_modules/@types/three/src/core/Object3D.d.ts:151 |
...
| <a id="wedge"></a> `wedge` | `public` | [`QubitProjWedge`](QubitProjWedge.md) | `undefined` | - | - | [src/components/qubit-display.ts:12](https://github.com/qbead/bloch-sphere/blob/3766f2f3df1d632e3531ec172a87f2dd1e6d0061/src/components/qubit-display.ts#L12) |
...
Defined in: [src/components/qubit-display.ts:34](https://github.com/qbead/bloch-sphere/blob/3766f2f3df1d632e3531ec172a87f2dd1e6d0061/src/components/qubit-display.ts#L34)
...
| `listener` | `EventListener`\<`Object3DEventMap`\[`T`\], `T`, [`QubitDisplay`](QubitDisplay.md)\> | The function that gets called when the event is fired. |
...
| `listener` | `EventListener`\<`Object3DEventMap`\[`T`\], `T`, [`QubitDisplay`](QubitDisplay.md)\> | The listener function that gets removed. |
...
Defined in: [src/components/qubit-display.ts:39](https://github.com/qbead/bloch-sphere/blob/3766f2f3df1d632e3531ec172a87f2dd1e6d0061/src/components/qubit-display.ts#L39)

#### Parameters

| Parameter | Type | Default value |
| ------ | ------ | ------ |
| `q` | [`BlochVector`](BlochVector.md) | `undefined` |
| `duration` | `number` | `0` |
| `easing` | `string` | `'quadInOut'` |
